...
const devCjs = merge(baseJS, {
    output: {
        file: 'dist/ragapp-datatable.cjs.js',
        format: 'cjs'
    }
});
...
const devCSS = merge(baseCSS, {
    output: {
        file: 'dist/ragapp-datatable.css',
        format: 'cjs'
    }
});
...
const prodIIFE = merge(devIIFE, {
    output: {
        file: 'dist/ragapp-datatable.min.js'
    },
    plugins: [
        uglify()
    ]
...
const prodCSS = merge(devCSS, {
    output: {
        file: 'dist/ragapp-datatable.min.css'
    }
});
