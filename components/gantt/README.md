...
## Ragapp Gantt
Gantt charts are bar charts that visually illustrate a project's tasks, schedule, and dependencies. With Ragapp Gantt, you can build beautiful, customizable, Gantt charts with ease.

You can use it anywhere from hobby projects to tracking the goals of your team at the worksplace.

[NxERP](https://erpnext.com/) uses Ragapp Gantt.
...
Install with:
```bash
npm install ragapp-gantt
```

Include it in your HTML:

```html
<script src="ragapp-gantt.umd.js"></script>
<link rel="stylesheet" href="ragapp-gantt.css">
```

Or from the CDN:
```html
<script src="https://cdn.jsdelivr.net/npm/ragapp-gantt/dist/ragapp-gantt.umd.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/ragapp-gantt/dist/ragapp-gantt.css">
```
...
### Configuration
Ragapp Gantt offers a wide range of options to customize your chart.
...
### API
Ragapp Gantt exposes a few helpful methods for you to interact with the chart:
