...
context("Form", () => {
	before(() => {
		...
		return cy
			...
			.its("ragapp")
			.then((ragapp) => {
				return ragapp.call("ragapp.tests.ui_test_helpers.create_contact_records");
			});
	});
	...
	it("create a new form", () => {
		...
		cy.intercept({
			method: "POST",
			url: "api/method/ragapp.desk.form.save.savedocs",
		}).as("form_save");
	...
	it("validates behaviour of Data options validations in child table", () => {
		...
		cy.get('.ragapp-control[data-fieldname="email_ids"]').as("table");
