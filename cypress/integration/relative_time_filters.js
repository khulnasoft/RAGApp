...
// 		cy.window().its('ragapp').then(ragapp => {
// 			ragapp.call("ragapp.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/ragapp.desk.reportview.get').as('list_refresh');
...
// 		cy.intercept('POST', '/api/method/ragapp.model.utils.user_settings.save')
