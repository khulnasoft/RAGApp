...
```shell
RAGAPP_VERSION=... ERPNEXT_VERSION=... docker buildx bake <targets>
```
...
# Ragapp and NxERP updates

Each Ragapp/NxERP release triggers new stable images builds as well as bump to helm chart.
...
Change following files on release of NxERP
