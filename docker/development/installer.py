...
def get_args_parser():
    ...
    parser.add_argument(
        ...
        action="store",
        type=str,
        help="Bench directory name, default: ragapp-bench",
        default="ragapp-bench",
    )  # noqa: E501
    parser.add_argument(
        "-s",
        "--site-name",
    ...
    parser.add_argument(
        ...
        action="store",
        type=str,
        help="ragapp repo to use, default: https://github.com/khulnasoft/ragapp",  # noqa: E501
    ...
    parser.add_argument(
        ...
        action="store",
        type=str,
        help="ragapp repo to use, default: version-15",  # noqa: E501
        default="version-15",
    )
    parser.add_argument(
        "-p",
...
def init_bench_if_not_exist(args):
    ...
    try:
        ...
        init_command += f"--ragapp-path={args.ragapp_repo} "
        init_command += f"--ragapp-branch={args.ragapp_branch} "
