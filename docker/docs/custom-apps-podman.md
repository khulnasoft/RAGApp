...
- Create `apps.json` file with custom apps listed in it
  ...
  [
    ...
    {
      "url": "https://github.com/khulnasoft/hrms",
      "branch": "version-15"
    },
    {
      "url": "https://github.com/khulnasoft/helpdesk",
      "branch": "main"
    }
  ]
  ```
...
- Configuration of parameters used when starting the containers
  - create `.env` file copying from example.env (Read more on setting up environment variables [here](https://github.com/khulnasoft/ragapp/blob/main/docs/environment-variables.md)
