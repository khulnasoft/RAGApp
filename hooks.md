...
1. `app_name` - slugified name e.g. "ragapp"
1. `app_title` - full title name e.g. "Ragapp"
1. `app_publisher`
1. `app_description`
1. `app_version`
...
1. `app_include_css` - assets/ragapp/css/splash.css

1. `web_include_js` - assets/js/ragapp-web.min.js
1. `web_include_css` - assets/css/ragapp-web.css
