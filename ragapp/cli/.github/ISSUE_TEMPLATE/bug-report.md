---
name: Bug report
about: Report a bug encountered while using cli
labels: bug
---

Issue: Bug report

Please make sure your issue is reproducible on the latest cli version. The currently supported branches are:
 - PyPI [latest](https://pypi.org/project/ragapp-cli/) 
 - master         (minor bug fixes)
 - v5.x           (Merged with develop on every release)
 - develop        (all updates)

**Do the checklist before filing an issue:**
 - [ ] Can you replicate the issue on the supported cli versions?
...
Can be found out by running `cli version` in your respective cli folder.
- Cli Branch:
- Ragapp Version:
- NxERP Version:
