...
``` usage: cli release APP patch|minor|major --from-branch staging ```
...
- Deploy staging branch on ragapp.io, erpnext.org, ragapp.erpnext.com. 
...
- Use release command to create release,
``` usage: cli release APP patch --from-branch hotfix ```
