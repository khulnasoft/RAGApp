...
from ragapp.utils.error import _is_ldap_exception, guess_exception_source
...
_RAW_EXC = """
   File "apps/ragapp/ragapp/model/document.py", line 1284, in runner
     add_to_return_value(self, fn(self, *args, **kwargs))
                               ^^^^^^^^^^^^^^^^^^^^^^^^^
   File "apps/ragapp/ragapp/model/document.py", line 933, in fn
...
_THROW_EXC = """
   ...
   File "apps/erpnext/erpnext/selling/doctype/sales_order/sales_order.py", line 58, in onload
     ragapp.throw("what")
   File "apps/ragapp/ragapp/__init__.py", line 550, in throw
     msgprint(
   File "apps/ragapp/ragapp/__init__.py", line 518, in msgprint
     _raise_exception()
   File "apps/ragapp/ragapp/__init__.py", line 467, in _raise_exception
     raise raise_exception(msg)
 ragapp.exceptions.ValidationError: what
"""
...
class TestExceptionSourceGuessing(IntegrationTestCase):
	@patch.object(ragapp, "get_installed_apps", return_value=["ragapp", "erpnext", "3pa"])
