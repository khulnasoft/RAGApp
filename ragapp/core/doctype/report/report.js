...
ragapp.ui.form.on("Report", {
	refresh: function (frm) {
		if (frm.doc.is_standard === "Yes" && !ragapp.boot.developer_mode) {
			...
			frm.add_custom_button(
				...
				function () {
					switch (doc.report_type) {
						case "Report Builder":
							ragapp.set_route("List", doc.ref_doctype, "Report", doc.name);
							break;
						case "Query Report":
							ragapp.set_route("query-report", doc.name);
							break;
						case "Script Report":
							ragapp.set_route("query-report", doc.name);
							break;
