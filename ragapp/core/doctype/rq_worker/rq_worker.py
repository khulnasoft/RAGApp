...
from ragapp.utils import cint, convert_utc_to_system_timezone
from ragapp.utils.background_jobs import get_workers
...
def serialize_worker(worker: Worker) -> ragapp._dict:
	...
	if current_job and not current_job.startswith(ragapp.local.site):
		current_job = None
