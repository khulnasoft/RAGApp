...
from ragapp.translate import MERGED_TRANSLATION_KEY, USER_TRANSLATION_KEY
...
def clear_user_translation_cache(lang):
	ragapp.cache.hdel(USER_TRANSLATION_KEY, lang)
	ragapp.cache.hdel(MERGED_TRANSLATION_KEY, lang)
