...
class DocTypeLayout(Document):
	...
	if TYPE_CHECKING:
		from ragapp.custom.doctype.doctype_layout_field.doctype_layout_field import DocTypeLayoutField
	...
	def sync_fields(self):
		doctype_fields = ragapp.get_meta(self.document_type, cached=False).fields
