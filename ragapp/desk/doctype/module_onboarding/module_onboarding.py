...
class ModuleOnboarding(Document):
	...
	if TYPE_CHECKING:
		from ragapp.desk.doctype.onboarding_permission.onboarding_permission import OnboardingPermission
		from ragapp.desk.doctype.onboarding_step_map.onboarding_step_map import OnboardingStepMap
	...
	def get_steps(self):
		return [ragapp.get_doc("Onboarding Step", step.step) for step in self.steps]
	...
	def reset_progress(self):
		...
		ragapp.msgprint(_("Module onboarding progress reset"), alert=True)
