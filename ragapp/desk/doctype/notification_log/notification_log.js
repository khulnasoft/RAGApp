...
ragapp.ui.form.on("Notification Log", {
	...
	set_attachment: function (frm) {
		...
		$wrapper.find(".attached-file-link").click(() => {
			const w = window.open(
				ragapp.urllib.get_full_url(`/api/method/ragapp.utils.print_format.download_pdf?
