...
class TestWorkspace(IntegrationTestCase):
	...
	def tearDown(self):
		ragapp.db.delete("Workspace", {"module": "Test Module"})
		ragapp.db.delete("DocType", {"module": "Test Module"})
		ragapp.delete_doc("Module Def", "Test Module")
	...
	# 	if ragapp.get_system_settings('country') == "France":
...
def create_module(module_name):
	module = ragapp.get_doc({"doctype": "Module Def", "module_name": module_name, "app_name": "ragapp"})
...
def create_workspace(**args):
	workspace = ragapp.new_doc("Workspace")
