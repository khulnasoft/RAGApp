...
import ragapp
from ragapp.query_builder import Interval, Order
from ragapp.query_builder.functions import Date, Sum, UnixTimestamp
...
def get_energy_points_heatmap_data(user, date):
	...
	eps_log = ragapp.qb.DocType("Energy Point Log")

	return dict(
		ragapp.qb.from_(eps_log)
...
def update_profile_info(profile_info):
	profile_info = ragapp.parse_json(profile_info)
