...
class TestDomain(IntegrationTestCase):
	...
	def tearDown(self):
		ragapp.delete_doc("Email Account", "Test")
		ragapp.delete_doc("Email Domain", "test.com")

	def test_on_update(self):
		mail_domain = ragapp.get_doc("Email Domain", "test.com")
		mail_account = ragapp.get_doc("Email Account", "Test")
