...
import ragapp
from ragapp import safe_decode
from ragapp.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from ragapp.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from ragapp.email.receive import Email
...
<div>
	...
	<img embed="assets/ragapp/images/ragapp-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/ragapp/images/ragapp-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = ragapp.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="ragapp-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/ragapp/images/ragapp-favicon.svg" alt="test" />
