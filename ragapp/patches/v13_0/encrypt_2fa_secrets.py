...
from ragapp.twofactor import PARENT_FOR_DEFAULTS
from ragapp.utils.password import encrypt
...
def execute():
	...
	secrets = {
		key: value
		for key, value in ragapp.defaults.get_defaults_for(parent=OLD_PARENT).items()
	...
	defvalue_cases = ragapp.qb.terms.Case()
