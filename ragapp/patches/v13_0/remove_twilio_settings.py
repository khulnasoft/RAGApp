...
def execute():
	...
	"""
	ragapp.delete_doc_if_exists("DocType", "Twilio Number Group")
	if twilio_settings_doctype_in_integrations():
		ragapp.delete_doc_if_exists("DocType", "Twilio Settings")
		ragapp.db.delete("Singles", {"doctype": "Twilio Settings"})


def twilio_settings_doctype_in_integrations() -> bool:
	"""Check Twilio Settings doctype exists in integrations module or not."""
	return ragapp.db.exists("DocType", {"name": "Twilio Settings", "module": "Integrations"})
