import ragapp
from ragapp.desk.doctype.notification_log.notification_log import make_notification_logs


def execute():
	if ragapp.get_all("Email Account", {"auth_method": "OAuth", "connected_user": ["is", "set"]}, limit=1):
		return
	...
	ragapp.db.set_value("Email Account", {"auth_method": "OAuth"}, "awaiting_password", 1)
...
def get_system_managers():
	user_doctype = ragapp.qb.DocType("User").as_("user")
	user_role_doctype = ragapp.qb.DocType("Has Role").as_("user_role")
	return (
