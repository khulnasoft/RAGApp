...
export function getStore(print_format_name) {
	...
	function fetch() {
		return new Promise((resolve) => {
			ragapp.model.clear_doc("Print Format", print_format_name);
			ragapp.model.with_doc("Print Format", print_format_name, () => {
				let _print_format = ragapp.get_doc("Print Format", print_format_name);
				ragapp.model.with_doctype(_print_format.doc_type, () => {
					meta.value = ragapp.get_meta(_print_format.doc_type);
	...
	function change_letterhead(_letterhead) {
		return ragapp.db.get_doc("Letter Head", _letterhead).then((doc) => {
