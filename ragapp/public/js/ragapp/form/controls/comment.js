...
ragapp.ui.form.ControlComment = class ControlComment extends ragapp.ui.form.ControlTextEditor {
	make_wrapper() {
		this.comment_wrapper = !this.no_wrapper
			...
			<div class="comment-input-wrapper">
				...
				${ragapp.avatar(ragapp.session.user, "avatar-medium")}
					<div class="ragapp-control col"></div>
				</div>
		...
		`)
			: $('<div class="ragapp-control"></div>');

		this.comment_wrapper.appendTo(this.parent);

		// wrapper should point to ragapp-control
		this.$wrapper = !this.no_wrapper
			? this.comment_wrapper.find(".ragapp-control")
