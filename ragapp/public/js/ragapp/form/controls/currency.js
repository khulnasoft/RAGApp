ragapp.ui.form.ControlCurrency = class ControlCurrency extends ragapp.ui.form.ControlFloat {
	...
	get_precision() {
		...
		if (typeof this.df.precision != "number" && !this.df.precision) {
			if (ragapp.boot.sysdefaults.currency_precision) {
				this.df.precision = ragapp.boot.sysdefaults.currency_precision;
			} else {
