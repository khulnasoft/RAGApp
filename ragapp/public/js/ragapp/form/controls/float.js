ragapp.ui.form.ControlFloat = class ControlFloat extends ragapp.ui.form.ControlInt {
	parse(value) {
	...
	get_number_format() {
		var currency = ragapp.meta.get_field_currency(this.df, this.get_doc());
		return get_number_format(currency);
	}

	get_precision() {
		// round based on field precision or float precision, else don't round
		return this.df.precision || cint(ragapp.boot.sysdefaults.float_precision, null);
	}
};

ragapp.ui.form.ControlPercent = ragapp.ui.form.ControlFloat;
