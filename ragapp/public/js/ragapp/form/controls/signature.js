ragapp.ui.form.ControlSignature = class ControlSignature extends ragapp.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		ragapp.require("/assets/ragapp/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${ragapp.utils.icon("restriction", "md")}</i>
