export default class GridPagination {
	...
	get_pagination_html() {
		...
		return $(`<button class="btn btn-secondary btn-xs first-page"">
			...
			<button class="btn btn-secondary btn-xs prev-page">${ragapp.utils.icon("left", "xs")}</button>
			${page_text_html}
			<button class="btn btn-secondary btn-xs next-page">${ragapp.utils.icon("right", "xs")}</button>
