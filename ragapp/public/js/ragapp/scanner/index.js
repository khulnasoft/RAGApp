...
ragapp.ui.Scanner = class Scanner {
	constructor(options) {
		this.dialog = null;
		this.handler = null;
		...
		if (options.container) {
			...
			this.scan_area_id = ragapp.dom.set_unique_id(this.$scan_area);
		}
		if (options.dialog) {
	...
	load_lib() {
		return ragapp.require("/assets/ragapp/node_modules/html5-qrcode/html5-qrcode.min.js");
	}
};
