...
ragapp.views.Container = class Container {
	...
	change_to(label) {
		...
		this.page._route = ragapp.router.get_sub_path();
		$(this.page).trigger("show");
		!this.page.disable_scroll_to_top && ragapp.utils.scroll_to(0);
	...
	has_sidebar() {
		var flag = 0;
		var route_str = ragapp.get_route_str();
		// check in ragapp.ui.pages
		flag = ragapp.ui.pages[route_str] && !ragapp.ui.pages[route_str].single_column;

		// sometimes ragapp.ui.pages is updated later,
