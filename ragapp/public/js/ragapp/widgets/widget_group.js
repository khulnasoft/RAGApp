...
ragapp.provide("ragapp.widget");

ragapp.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
ragapp.widget.make_widget = (opts) => {
	const widget_class = ragapp.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = ragapp.widget.make_widget({
			...widget,
...
ragapp.widget.WidgetGroup = WidgetGroup;
ragapp.widget.SingleWidgetGroup = SingleWidgetGroup;
