...
to provide custom formatting and logging for test results in the Ragapp framework.
...
test results during test execution in the Ragapp framework.
"""
...
class TestResult(unittest.TextTestResult):
	...
	def startTestRun(self):
		if not sys.warnoptions:
			...
			from ragapp.deprecation_dumpster import RagappDeprecationWarning

			warnings.simplefilter("ignore")
			warnings.filterwarnings("module", category=RagappDeprecationWarning)
