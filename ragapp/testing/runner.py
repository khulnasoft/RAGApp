"""
This module contains the TestRunner class, which is responsible for executing test suites in Ragapp.
...
- Integration with Ragapp's configuration and environment setup
...
Usage:
The TestRunner is typically instantiated and used by Ragapp's test discovery and execution system.
...
class TestRunner(unittest.TextTestRunner):
	...
	def _prepare_category(self, category, suite, app):
		from ragapp.deprecation_dumpster import get_compat_ragapp_test_case_preparation

		dispatcher = {
			"integration": self.integration_preparation,
			"old-ragapp-test-class-category": get_compat_ragapp_test_case_preparation(self.cfg),
