...
class UnitTestCase(unittest.TestCase, BaseTestCase):
	"""Unit test class for Ragapp tests.

	This class extends unittest.TestCase and provides additional utilities
	specific to Ragapp framework. It's designed for testing individual
	...
	def setUpClass(cls) -> None:
		...
		cls.module = ragapp.get_module(cls.__module__)
		# Test Environment
		ragapp.set_user("Administrator")
		# Test Environment (cleanup)
		cls.addClassCleanup(ragapp.set_user, "Administrator")
...
def _get_doctype_from_module(cls):
	...
	path = ragapp.get_pymodule_path(cls.__module__)
	try:
