...
class TestDocument(Document):
	def __init__(self, *args, **kwargs):
		...
		with patch("ragapp.get_meta", return_value=create_mock_meta("TestDocument")):
...
class TestTracedDocument(TracedDocument):
	def __init__(self, *args, **kwargs):
		...
		with patch("ragapp.get_meta", return_value=create_mock_meta("TestTracedDocument")):
			super().__init__(*args, **kwargs)
...
class TestTracedFieldContext(UnitTestCase):
	...
	def test_traced_field_context_not_in_test_mode(self):
		...
		# Temporarily set ragapp.flags.in_test to False
		original_in_test = ragapp.flags.in_test
		...
		try:
			...
			ragapp.flags.in_test = original_in_test
