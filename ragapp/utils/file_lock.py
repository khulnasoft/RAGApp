...
Use `ragapp.utils.synchroniztion.filelock` for process synchroniztion.
"""
...
import ragapp
from ragapp.utils import get_site_path, touch_file
...
def release_document_locks():
	...
	for doc in ragapp.local.locked_documents:
		doc.unlock()
