...
class TestHelpArticle(IntegrationTestCase):
	...
	def setUpClass(cls) -> None:
		cls.help_category = ragapp.get_doc(
			{
		...
		cls.help_article = ragapp.get_doc(
			{
	...
	def test_article_is_helpful(self):
		from ragapp.website.doctype.help_article.help_article import add_feedback
	...
	def tearDownClass(cls) -> None:
		ragapp.delete_doc(cls.help_article.doctype, cls.help_article.name)
		ragapp.delete_doc(cls.help_category.doctype, cls.help_category.name)
