...
import ragapp
from ragapp.utils import cstr, escape_html, get_request_site_address, now
...
def get_context(context):
	...
	blog_settings = ragapp.get_doc("Blog Settings", "Blog Settings")
