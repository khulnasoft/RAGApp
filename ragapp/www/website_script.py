...
import ragapp
from ragapp.utils import strip
...
def get_context(context):
	context.javascript = ragapp.db.get_single_value("Website Script", "javascript") or ""
...
def get_setting(field_name):
	...
	website_settings = ragapp.db.get_single_value("Website Settings", field_name)
	conf = ragapp.conf.get(field_name)
